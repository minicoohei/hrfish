<template>
  <div class="main-view">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">Career Simulation</span>
        </div>
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step3 Career Simulation -->
...
// Get maxRounds from query params at init time so child component has it immediately
...
const handleGoBack = async () => {
  // Close running simulation before going back to Step 2
...
onMounted(() => {
  ...
  // Log maxRounds config (already obtained from query params at init)
  if (maxRounds.value) {
