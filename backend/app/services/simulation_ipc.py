...
Uses file-system based command/response pattern:
...
class SimulationIPCClient:
    ...
    For sending commands to simulation process and waiting for response
    """
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms for dual-platform sim, or that platform for single-platform
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: Interview each agent on both platforms for dual-platform sim
            timeout: Timeout duration
