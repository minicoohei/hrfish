              ...
              <div class="timeline-content">
                ...
                <div class="timeline-body" :class="{ 'collapsed': isLogCollapsed(log) }" @click="toggleLogExpand(log)">
                  ...
                  <template v-if="log.action === 'llm_response'">
                    ...
                    <!-- When final answer, show special prompt -->
...
const parseInsightForge = (text) => {
  ...
  try {
    ...
    // Extract stats - match "related prediction facts: X items" format
...
const parseInterview = (text) => {
  ...
  try {
    ...
    // Parse selection reason for each person
    const parseIndividualReasons = (reasonText) => {
      ...
      for (const line of lines) {
        ...
        // e.g.: - Select parent_601(index 0): representative...
        if (!headerMatch) {
        ...
        // e.g.: - **parent_601(index 0)**: representative...
        if (!headerMatch) {
    ...
    interviewBlocks.forEach((block, index) => {
      ...
      if (qMatch) {
        ...
        // Split questions by numbered items
      ...
      if (answerMatch) {
        ...
        // Platform fallback (backward compat: single platform marker)
