<template>
  <div class="main-view">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">Stakeholder Setup</span>
        </div>
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step2 Stakeholder Setup -->
...
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      addLog('Running simulation environment detected, closing...')
      ...
      try {
        ...
        if (closeRes.success) {
          ...
          addLog(`Failed to close environment: ${closeRes.error || 'Unknown error'}`)
      ...
      // Environment not running, but process may still be active
    ...
    // Env status check failure doesn't block subsequent flow
